...
// @router /api/products/update_basis/ [PUT]
func UpdateProductBasicInfo(ctx context.Context, c *app.RequestContext) {
	var err error
	var req product.BasicProdInfo
	err = c.BindAndValidate(&req)
	if err != nil {
		responder.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	...
	resp, err := handler.NewUpdateProductBasicInfoService(ctx, c).Do(&req)
	if err != nil {
		responder.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	}
...
// UpdateProdShowcase .
// @router /api/products/update_showcase [PUT]
func UpdateProdShowcase(ctx context.Context, c *app.RequestContext) {
	var err error
	var req product.ProductShowcase
	err = c.BindAndValidate(&req)
	if err != nil {
		responder.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	...
	resp, err := handler.NewUpdateProdShowcaseService(ctx, c).Do(&req)
	if err != nil {
		responder.SendErrResponse(ctx, c, consts.StatusOK, err)
		return
	}
