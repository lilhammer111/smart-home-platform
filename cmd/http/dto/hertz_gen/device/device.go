...
var DeviceFilter_IsOnline_DEFAULT bool

func (p *DeviceFilter) GetIsOnline() (v bool) {
	if !p.IsSetIsOnline() {
		return DeviceFilter_IsOnline_DEFAULT
	}
	return *p.IsOnline
}
...
func (p *DeviceFilter) IsSetIsOnline() bool {
...
type DeviceInfo struct {
	...
	Model           string `thrift:"Model,4,required" form:"model,required" json:"model,required"`
...
func (p *DeviceInfo) GetModel() (v string) {
	return p.Model
}

func (p *DeviceInfo) GetType() (v string) {
	return p.Type
}
