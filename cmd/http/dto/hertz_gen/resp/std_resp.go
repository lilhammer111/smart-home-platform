...
type Any struct {
	StringValue *string         `thrift:"StringValue,1,optional" form:"StringValue" json:"StringValue,omitempty" query:"StringValue"`
	IntValue    *int32          `thrift:"IntValue,2,optional" form:"IntValue" json:"IntValue,omitempty" query:"IntValue"`
	BoolValue   *bool           `thrift:"BoolValue,3,optional" form:"BoolValue" json:"BoolValue,omitempty" query:"BoolValue"`
	ListValue   []string        `thrift:"ListValue,4,optional" form:"ListValue" json:"ListValue,omitempty" query:"ListValue"`
	MapValue    map[string]*Any `thrift:"MapValue,5,optional" form:"MapValue" json:"MapValue,omitempty" query:"MapValue"`
}
