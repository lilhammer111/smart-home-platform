...
func (p *kBrandServiceClient) GetBrandByCategory(ctx context.Context, req *product.GetBrandByCatReq, callOptions ...callopt.Option) (r []*product.BrandInfo, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
...
func (p *kBrandServiceClient) DelteBrand(ctx context.Context, req *common.Req, callOptions ...callopt.Option) (r *common.Empty, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
