module git.zqbjj.top/pet/services/cmd/rpc/device
...
require (
	git.zqbjj.top/lilhammer111/micro-kit v0.0.0-20231221140745-c9734e83f9c1
...
require (
	...
	github.com/kitex-contrib/obs-opentelemetry/logging/logrus v0.0.0-20231211030816-1f9e0f7bcee3 // indirect
