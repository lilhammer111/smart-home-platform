...
service alert {
    ...
    AlertInfoResp GetAlertDetail(1: common.Req req) (api.get="/api/devices/alerts/detail");
    ...
    common.Resp DeleteAlert(1: common.Req req) (api.delete="/api/devices/alerts/delete");
}