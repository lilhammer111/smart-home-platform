...
struct AlertsFilter {
    1: optional i8 AlertLevel (api.query="alert_level", api.vd="in($, 0, 1, 2)");
    2: optional i16 Page (api.query="page", api.vd="$>=0");
    3: optional i16 Limit (api.query="limit", api.vd="$>0");
    4: optional i32 DeviceId (api.body="device_id");
...
service alerts {
    std_resp.StdResp GetAlertList(1: AlertsFilter req) (api.get="/api/devices/alerts");
    std_resp.StdResp GetAlertDetail(1: req.IdReq req) (api.get="/api/devices/alerts/detail");
    std_resp.StdResp UpdateAlertInfo(1: AlertInfo req) (api.put="/api/devices/alerts");
    std_resp.StdResp UploadAlertInfo(1: AlertInfo req) (api.post="/api/devices/alerts");
    std_resp.StdResp DeleteAlert(1: req.IdReq req) (api.delete="/api/devices/alerts");
}