...
service feed_program {
    ProgramListResp GetSelfProgramList(1: common.Req req) (api.get="/api/programs/list");
    ProgramInfoResp GetProgramDetail(1: common.Req req) (api.get="/api/programs/detail");
    ...
    common.Resp FeedNow(1: FeedNowReq req) (api.post="/api/programs/feed_now");
    common.Resp DeleteProgram(1: common.Req req) (api.delete="/api/programs/delete");
}